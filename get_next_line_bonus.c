...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/15 01:39:55 by afaqir            #+#    #+#             */
/*   Updated: 2023/03/15 02:28:12 by afaqir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	ptr[fd] = read_full_line(fd, ptr[fd]);
	if (!ptr[fd])
		return (NULL);
	line = updated_line(ptr[fd]);
	ptr[fd] = ft_adjust_line(ptr[fd]);
	return (line);
}
